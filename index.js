...
app.use((req, res, next) => {
    ...
    if (isAllowed && origin) {
        ...
        if (!res.getHeader('Access-Control-Allow-Origin')) {
            ...
            res.setHeader('Access-Control-Allow-Headers', 'Content-Type, Authorization, X-Requested-With, Accept, x-doctor-id');
...
// Basic Route
app.get('/', (req, res) => {
    res.json({ message: 'Welcome to New Venus Clinic Portal API' });
});
